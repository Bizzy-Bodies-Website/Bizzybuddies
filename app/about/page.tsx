...
export default function ABOUT() {
  ...
  const aboutUsBlock = pageData.contentBlocks.find(
    (block: any) => block._type === "aboutUs"
  );
  ...
  const ctaBlock = pageData.contentBlocks.find(
      ...
      <div className="bg-white flex flex-col items-center w-full">
        <div className="bg-white w-full relative">
          ...
          <main className="w-full">
              ...
              <section
                ...
                style={{
                  backgroundImage: heroBlock?.backgroundImage
                    ? `url(${urlFor(heroBlock.backgroundImage.asset).url()})`
                    : "",
            ...
            {/* Contact Us Section */}
            {data.joinaSession && <ContactUsSection data={data.joinaSession} />}
          </main>
        </div>
      </div>
    </div>
